...
class AnfitriaoController{
    ...
    public function __construct()
    {
        ...
        else if(isset($_GET['funcao']) && $_GET['funcao'] == "deleteImg")
        {
            $this->delete($_GET['id']);
        }
    ...
    public function create()
    {
        ...
        if ($result) {
            echo "<script>alert('Anfitrião cadastrado com sucesso!');document.location='../View/login-cadastro.php'</script>";
        } else {
...
public function updatelogado()
{
    ...
    if (isset($_POST['id'])) {
        ...
        $result = $this->anfitriao->update($id);
        if ($result) {
            echo "<script>alert('Dados atualizados com sucesso!');document.location='../View/AutoPerfil.php'</script>";
        } else {
            echo "<script>alert('Erro ao atualizar os Dados! Verifique os Campos.');document.location='../View/AutoPerfil.php'</script>";
        }
    } else {
        echo "ID não foi fornecido no POST.";
