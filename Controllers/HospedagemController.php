    ...
    public function create()
{
    ...
    $this->hospedagem->setCod_animal($_GET['cod_animal']); // Alteração aqui

    $result = $this->hospedagem->create();
    if ($result) {
        echo "<script>alert('Hospedagem agendada com sucesso!');document.location='../View/agenda-tutor.php'</script>";
    } else {
    ...
    public function delete($cod_hospedagem) {
        ...
        if ($deleted) {
            echo "<script>alert('Hospedagem excluida com sucesso');document.location='../view/home.php'</script>";
        } else {
