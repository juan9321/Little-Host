            ...
            <div class="content">
                ...
                <form action="../Controllers/AnfitriaoController.php?funcao=updatelogado" method="POST" class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="password" length="8" class="form-control" autocomplete="off" placeholder="**********" require id="inputSenha" name="Senha" value="<?php echo $anfitriao['senha']; ?>">
                    </div>
                    
                    <div class="button">
                    <label for="Preferencias" class="form-label">Preferências</label>
                        <input type="text" class="form-control" id="Preferencias" autocomplete="off" required placeholder="Preferências" name="Preferencias" value="<?php echo $anfitriao['preferencias']; ?>"><br>
