...
if (isset($_GET['id'])) {
    ...
    $anfitriao = $controller->read($id); // Use a função read para obter os dados do anfitrião específico
} else {
        ...
        <div class="container">
            <div class="profile">
                ...
                <div class="imageContainer">
                    <?php if (isset($anfitriao['imagem_perfil']) && file_exists($anfitriao['imagem_perfil'])) { ?>
                        <img src="<?php echo $anfitriao['imagem_perfil']; ?>" alt="Imagem do Anfitrião" class='imagem-100x100'>
                    <?php } else { ?>
                        <img src="img/perfil.png" id="imgPhoto" alt="Imagem padrão" class='imagem-100x100'>
                    <?php } ?>
                </div>
                </div>
                <!--fim-->
                ...
                <h1>                
                    <?php echo $anfitriao['nome']; ?>
                </h1>
                <p>Email: <?php echo $anfitriao['email']; ?></p>
                <p>Telefone: <?php echo $anfitriao['telefone']; ?></p>
                <p>Endereco: <?php echo $anfitriao['endereco']; ?></p>
                <p>Bairro: <?php echo $anfitriao['bairro']; ?></p>
                <br>
                <p>Complemento: <?php echo $anfitriao['complemento']; ?></p>
                <p>Preferencias: <?php echo $anfitriao['preferencias']; ?></p>
                <br>
                <p>Valor Hora: <?php echo $anfitriao['valor_hora']; ?></p>
            </div>
